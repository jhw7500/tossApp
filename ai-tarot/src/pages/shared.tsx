...
export function PageIntro({ eyebrow = 'tarororo', title, description }: { eyebrow?: string; title: string; description?: string }) { return <header className="page-intro"><p className="eyebrow">{eyebrow}</p><h1 className="page-title" tabIndex={-1}>{title}</h1>{description && <p className="intro-description">{description}</p>}</header> }
